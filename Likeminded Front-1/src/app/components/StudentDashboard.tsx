...
import { ScrollReveal, FadeIn, ScaleIn } from './ui/scroll-reveal';
        ...
        <FadeIn delay={0.2}>
          ...
          <div className="grid grid-cols-3 gap-3">
            {quickActions.map((action, index) => {
              ...
              return (
                <ScaleIn key={action.label} delay={0.3 + index * 0.1}>
                  <button className="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-all active:scale-95">
